...
class Process:
    def __init__(self):
        ...
        self.UI_AUTO_PROCESS = "ui_autotest_process"
        self.FAILED_TESTCASE_NAMES = "failed_testcase_name"
        self.RUNNING_STATUS = "running_status"

    def reset_all(self):
        # 删除所有进度
        self.redis_client.delete(self.UI_AUTO_PROCESS)
        # 删除所有失败用例的名称
    ...
    def update_success(self):
        ...
        :return:
        """
        self.redis_client.hincrby(self.UI_AUTO_PROCESS, "success")
    ...
    def update_fail(self):
        ...
        :return:
        """
        self.redis_client.hincrby(self.UI_AUTO_PROCESS, "fail")
    ...
    def get_fail_testcase_name(self):
        """
        获取所有失败的用例名称
        :return:
        """
