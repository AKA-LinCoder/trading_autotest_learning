...
class GoodsPage(GoodsBase, ObjectMap):
    ...
    def upload_goods_img(self, driver, img_name):
        ...
        img_xpath = self.goods_img()
        return self.upload(driver, By.XPATH, img_xpath, img_path)
    ...
    def select_goods_status(self, driver, select_name):
        ...
        self.element_click(driver, By.XPATH, goods_status_select_xpath)
    ...
    def add_new_goods(self, driver, goods_title, goods_detail, goods_num, goods_price, good_img_list, goods_status,
                      button_name):
        """
        新增二手商品
        :param driver:
        ...
        for goods_pic in good_img_list:
